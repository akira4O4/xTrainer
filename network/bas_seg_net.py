...
class RefUnet(nn.Module):
    def __init__(self, in_ch, inc_ch, out_channels=1):
        ...
        self.conv_d0 = nn.Conv2d(64, out_channels, 3, padding=1)
...
class BasSegNet(nn.Module):
    def __init__(self, n_channels=3, num_classes=1, **kwargs):
        ...
        self.refunet = RefUnet(self.out_channels, 64, out_channels=num_classes)
