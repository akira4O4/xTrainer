...
class RefUnet(nn.Module):
    def __init__(self, in_ch, inc_ch, mask_classes=1):
        ...
        self.conv_d0 = nn.Conv2d(64, mask_classes, 3, padding=1)
...
class BasSegNet(nn.Module):
    def __init__(self, n_channels=3, num_classes=1, mask_classes=1, **kwargs):
        super(BasSegNet, self).__init__()

        resnet = models.resnet34(pretrained=True)

        self.out_channels = mask_classes
        ...
        self.outconv2 = nn.Conv2d(64, self.out_channels, 3, padding=1)
        self.outconv1 = nn.Conv2d(64, self.out_channels, 3, padding=1)

        self.refunet = RefUnet(self.out_channels, 64, mask_classes=self.out_channels)
